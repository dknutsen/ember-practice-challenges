...
module('Challenges | basics.defining-links', function (hooks) {
  ...
  test('the route link is defined correctly', async function (assert) {
    ...
    assert
      .dom('#route-link a')
      .hasText('Route link', 'the link text is correct');
    ...
    assert
      .dom('#param')
      .hasText('query param foo: bar', 'the query param is correctly defined');
  });
  ...
  test('the external link is defined correctly', async function (assert) {
    ...
    assert
      .dom('#external-link a')
      .hasAttribute('target', '_blank', 'the link href is correct');
    assert
      .dom('#external-link a')
      .hasAttribute(
        'rel',
    ...
    assert
      .dom('#external-link a')
      .hasText('Google it', 'the link text is correct');
  });
});
